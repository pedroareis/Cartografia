...
#    cyclic_temp = add_cyclic_point(temp)
    ...
    ax.cbar_axes[0].colorbar(ax_contour)
...
#    ax_gridlines.xformatter = LONGITUDE_FORMATTER
#    ax_gridlines.yformatter = LATITUDE_FORMATTER
